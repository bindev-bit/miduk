<x-app-layout>
    <form action="{{ route('kapal.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" min="1" name="kapasitas" id="kapasitas"
                                        autocomplete="kapasitas" value="{{ old('kapasitas') }}"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div x-show="sewaHarian">
                                    ...
                                    <div class="mt-1 mb-4 flex rounded-md shadow-sm">
                                        ...
                                        <input type="number" min="1000" name="sewa_hari" id="sewa_hari"
                                            autocomplete="sewa_hari"
                                            class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                                    </div>
                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div x-show="sewaJam">
                                    ...
                                    <div class="mt-1 mb-4 flex rounded-md shadow-sm">
                                        ...
                                        <input type="number" min="1000" name="sewa_jam" id="sewa_jam"
                                            autocomplete="sewa_jam"
                                            class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                                    </div>
